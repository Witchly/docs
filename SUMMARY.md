...
* [📦 Migrating to Witchly (Move Your Server)](getting-started/migrating-to-witchly-move-your-server.md)
* [🛒 Step 1: Buying Your Server](getting-started/step-1-buying-your-server.md)
* [💳 Step 2: Checkout & Payment](getting-started/step-2-checkout-and-payment.md)
* [📧 Step 3: Activation & Password](getting-started/step-3-activation-and-password.md)
* [🕹️ Step 4: Starting & Joining](getting-started/step-4-starting-and-joining.md)
* [💳 Billing & Account FAQ](getting-started/billing-and-account-faq.md)
...
* [🌐 Custom Domain: Minecraft](minecraft-java-and-bedrock/custom-domain-minecraft.md)
* [🔄 Changing Server Version: Minecraft](minecraft-java-and-bedrock/changing-server-version-minecraft.md)
* [🛠️ Troubleshooting](minecraft-java-and-bedrock/troubleshooting.md)

## Hytale

* [🗡️ Getting Started with Hytale](hytale/getting-started-with-hytale.md)
...
* [🐼 Getting Started with Palworld](palworld/getting-started-with-palworld.md)
...
* [📂 Using SFTP (File Manager)](others/using-sftp-file-manager.md)
* [💾 Backups & Databases](others/backups-and-databases.md)
* [⏰ Schedules (Auto-Restarts)](others/schedules-auto-restarts.md)
* [🔐 Account Security](others/account-security.md)
* [🌐 Server Address & Domains](others/server-address-and-domains.md)
* [🆘 How to Get Help Fast](others/how-to-get-help-fast.md)
